      ...
      <div className="w-[1040px] pt-6 pb-10">
        ...
        <div className="mb-6 flex items-center gap-4 w-full">
          ...
          <button
            ...
            className="flex w-[187px] h-[48px] px-[16px] py-[12px] items-center justify-center gap-[10px] rounded-[8px] bg-[#7B6154] text-white text-[14px] font-semibold hover:opacity-90"
          >
            소식 등록
          </button>
        </div>
