      ...
      <div className="py-4 t:pt-6 px-3 t:px-10">
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-[1040px]">
            ...
            {/* 입력 박스 */}
            <div
              className={`relative flex w-full p-4 t:p-5 flex-col rounded-2 border border-Subbrown-4 t:border-2 bg-White ${selectedOption === "vote" ? "min-h-63" : "h-63"} t:h-190`}
            >
              {/* 제목 */}
              ...
              <div className="mt-auto pt-6 flex justify-center t:justify-end gap-4">
                <button
                  ...
                  className={`flex items-center gap-2 body_1_2 transition-colors ${
                    selectedOption === "vote" ? "text-Gray-7" : "text-Gray-4"
                  }`}
                >
                  <Image
                    src="/vote.svg"
                    ...
                    height={20}
                    className={
                      selectedOption === "vote" ? "opacity-100" : "opacity-40"
                    }
                  />
                  투표 생성
                </button>
                ...
                <button
                  ...
                  className={`flex items-center gap-2 body_1_2 transition-colors ${
                    selectedOption === "image" ? "text-Gray-7" : "text-Gray-4"
                  }`}
                >
                  <Image
                    src="/image.svg"
                    ...
                    height={20}
                    className={
                      selectedOption === "image" ? "opacity-100" : "opacity-60"
                    }
                  />
                  이미지 파일
                </button>
