            ...
            <nav className="flex flex-row justify-center gap-[7px] t:gap-[8px] d:flex-col d:gap-3 d:justify-start t:mx-auto">
              ...
              >
                <div className="relative flex items-center justify-center w-6 h-6 t:w-6 t:h-6 d:w-8 d:h-8 shrink-0">
                  <div className={`absolute inset-0 rounded-lg hidden d:block ${isSidebarExpanded ? "bg-primary-2 -m-4" : ""}`} />
                  ...
                  return (
                    <Link
                      ...
                      className={`
                        ...
                        ${
                          isSidebarExpanded ? "d:w-full d:justify-start d:h-auto d:py-4" : "d:w-fit d:justify-center d:h-auto d:py-4"
                        }
                      `}
                    >
