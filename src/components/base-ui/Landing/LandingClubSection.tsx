...
export default function LandingClubSection() {
  return (
    <section className="relative overflow-hidden py-20 t:py-32">
      <Image src="/landing/landing-third-backgroud.svg" alt="" fill className="object-cover" />
      ...
      <div className="relative z-10 mx-auto flex max-w-[1200px] flex-col items-center gap-8 px-4 t:gap-10 t:px-6 d:px-8">
        ...
        <FadeInSection delay={0.15} className="relative z-20 mx-auto w-[90%] t:w-[76%]">
          <Image src="/landing/landing-third-screen.svg" alt="독서 모임 화면" width={900} height={580} className="w-full rounded-xl shadow-2xl" />
