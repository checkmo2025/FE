  ...
  return (
    <section className="overflow-hidden bg-white py-20 t:py-28">
      <div className="mx-auto max-w-[1200px] px-4 t:px-6 d:px-8">
        ...
        {/* 텍스트 */}
        <FadeInSection className="mb-10 flex flex-col gap-4 t:w-[40%]">
        ...
        {/* 모바일 레이아웃 (375 only) */}
        <FadeInSection delay={0.15} className="flex flex-col gap-6 t:hidden">
        ...
        {/* 태블릿 레이아웃 (768~1440) */}
        <FadeInSection delay={0.15} className="hidden t:flex d:hidden items-start gap-5">
        ...
        {/* 데스크탑 레이아웃 */}
        <FadeInSection delay={0.15} className="relative hidden h-[600px] d:block">
          ...
          <div className="absolute right-[4%] z-10 w-[62%] origin-top-right scale-[0.72]" style={{ top: "-260px" }}>
            <div className="w-full drop-shadow-lg">
              <Image src="/landing/landing-fifth-screen1.svg" alt="모임 가입 신청 관리" width={720} height={200} className="w-full rounded-xl" />
            </div>
            <div className="relative mt-4 w-full drop-shadow-xl">
              <Image src="/landing/landing-fifth-screen2.svg" alt="투표 화면" width={720} height={420} className="w-full rounded-xl" />
