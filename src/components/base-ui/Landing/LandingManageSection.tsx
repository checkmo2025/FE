...
export default function LandingManageSection() {
  return (
    <section className="bg-white py-20 t:py-28">
      <div className="mx-auto flex max-w-[1200px] flex-col items-center gap-12 px-6 t:flex-row t:items-start t:gap-10 d:px-8">
        {/* 좌측: 텍스트 + 모바일 목업 */}
        <div className="flex flex-col gap-8 t:w-[42%] t:shrink-0">
          ...
          {/* 모바일 화면 - 폰 프레임 안에 */}
          <div className="flex justify-center t:justify-start">
        ...
        {/* 우측: 데스크탑 화면 2장 + screen3 오버레이 */}
        <div className="relative flex flex-1 flex-col gap-4 pt-4 t:scale-[0.72] t:origin-top-left">
          {/* 상단 화면 - 모임 가입 신청 관리 */}
