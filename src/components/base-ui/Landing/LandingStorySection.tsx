  ...
  return (
    <section className="relative overflow-hidden bg-white py-20 t:py-28">
      <div className="mx-auto flex max-w-[1200px] flex-col gap-8 px-4 t:flex-row t:items-start t:gap-16 t:px-6 d:px-8">
        <FadeInSection className="flex flex-col gap-4 t:w-[38%] t:shrink-0 t:pt-10">
        ...
        <FadeInSection delay={0.15} className="relative w-full pb-10 t:flex-1 t:pb-0">
          <Image src="/landing/landing-fourth-screen.svg" alt="책 이야기 화면" width={700} height={460} className="w-full rounded-xl shadow-xl" />
          <div className="absolute -bottom-8 -right-4 w-[26%] t:-bottom-10 t:-right-12 t:w-[30%]">
            <Image src="/landing/landing-fourth-books.svg" alt="" width={220} height={200} className="w-full" />
          </div>
        </FadeInSection>
      </div>
    </section>
