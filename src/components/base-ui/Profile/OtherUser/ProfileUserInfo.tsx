  ...
  return (
    <div className="flex w-[734px] flex-col items-center gap-[40px]">
      ...
      <div className="flex items-center gap-[24px] self-stretch">
        <button
          type="button"
          className="flex h-[48px] w-[532px] items-center justify-center rounded-[8px] bg-[#7B6154] transition-colors hover:bg-[#5E4A40]"
        >
          <span className="text-[18px] font-medium text-white">구독하기</span>
        </button>

        <button
          type="button"
          className="flex h-[48px] w-[178px] items-center justify-center rounded-[8px] border border-[#D2C5B6] bg-white transition-colors hover:bg-gray-50"
        >
