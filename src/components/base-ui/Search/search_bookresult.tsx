  ...
  return (
    ...
    >
      <div className="relative w-[126px] h-[183px] shrink-0">
        <Image src={coverSrc} alt={title} fill sizes="126px" className="object-cover" />
      </div>

      <div className="flex flex-1 min-w-0 items-start gap-[24px]">
        <div className="flex flex-col min-w-0 flex-1">
          <p className="text-[color:var(--Gray_7,#2C2C2C)] Subhead_3 truncate">{title}</p>
          <p className="text-[color:var(--Gray_4,#8D8D8D)] Subhead_4_1 truncate">{author}</p>
