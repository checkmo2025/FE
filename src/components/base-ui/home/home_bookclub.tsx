...
export default function HomeBookclub({ groups }: Props) {
  ...
  return (
    <aside
      className={[
        "flex flex-col w-[332px] p-5 rounded-[10px] bg-[color:var(--Subbrown_4)]",
      ...
      <div className="mt-auto pt-3">
        {isMany ? (
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              <Image src="/search.svg" alt="모임 검색하기" width={24} height={24} />
              <span className="text-[color:var(--primary_3)] Subhead_4_1">모임 검색하기</span>
